    ...
    <div className="min-h-screen bg-[#FAF7F2]">
      <div className="bg-[#1B4332] text-white py-32 px-6 text-center">
        ...
        <p className="text-gray-300 max-w-xl mx-auto">
          We would love to hear from you. Reach out for bookings, enquiries or just to say hello.
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          <div>
            ...
            <div className="flex flex-col gap-6 mb-10">
              {[
                { icon: Phone, label: 'Phone', value: '072 363 2861', href: 'tel:+27723632861' },
                { icon: MessageCircle, label: 'WhatsApp', value: '072 363 2861', href: 'https://wa.me/27723632861' },
                { icon: Mail, label: 'Email', value: 'reservations@solanavillas.co.za', href: 'mailto:reservations@solanavillas.co.za' },
                { icon: MapPin, label: 'Location', value: 'Sabie River Eco Estate, Hazyview, Mpumalanga', href: 'https://maps.google.com/?q=Sabie+River+Eco+Estate+Hazyview' },
              ].map((item, i) => (
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit}
                ...
                <select value={form.subject}
                        ...
                        className="border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#1B4332] text-gray-500">
                ...
                <button type="submit" disabled={loading}
                        className="w-full bg-[#1B4332] hover:bg-green-900 disabled:opacity-50 text-white py-4 rounded-xl font-medium transition-colors">
