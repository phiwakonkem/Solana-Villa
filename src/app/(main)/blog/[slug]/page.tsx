...
export default function VillaPage({ params }: { params: { slug: string } }) {
  ...
  if (!villa) return <div className="min-h-screen flex items-center justify-center">Villa not found</div>
    ...
    return (
      <div className="min-h-screen bg-[#FAF7F2] flex items-center justify-center px-6">
        <div className="text-center max-w-lg">
          ...
          <h1 className="font-[Playfair_Display] text-4xl font-bold text-[#1B4332] mb-4">
            {villa.name}
          </h1>
          <p className="text-gray-500 leading-relaxed mb-8">
            This property is currently under construction within the Sabie River
            Eco Estate. We can't wait to share it with you — follow along on
            Instagram for progress updates, or get in touch and we'll let you
            know the moment it's ready to book.
          </p>
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2]">
      <div className="relative h-[70vh] overflow-hidden">
        <img src={villa.exteriorImages[0] || villa.interiorImages[0]} alt={villa.name}
             className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
        <div className="absolute bottom-0 left-0 right-0 p-12 text-white">
          <p className="text-[#D4A853] text-xs tracking-widest uppercase mb-2">{villa.location}</p>
          <h1 className="font-[Playfair_Display] text-6xl font-bold mb-2">{villa.name}</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <div className="flex gap-8 mb-10 pb-10 border-b border-gray-200">
              <div className="text-center">
                <p className="text-3xl font-bold text-[#1B4332]">{villa.guests}</p>
                <p className="text-gray-500 text-sm">Guests</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#1B4332]">{villa.bedrooms}</p>
                <p className="text-gray-500 text-sm">Bedrooms</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#1B4332]">{villa.bathrooms}</p>
            ...
            <div className="mb-10">
              <h2 className="font-[Playfair_Display] text-2xl font-bold text-[#1B4332] mb-4">
                About this Villa
              </h2>
            ...
            <div className="mb-10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {villa.amenities.map(a => (
                  <div key={a.name}
                       className="bg-white rounded-xl p-4 text-center border border-gray-100 hover:border-[#D4A853] transition-colors">
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 h-64 flex items-center justify-center">
                <div className="text-center text-gray-400">
                  ...
                  <a href="https://maps.google.com/?q=Sabie+River+Eco+Estate+Hazyview"
                     target="_blank"
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <BookingForm villaName={villa.name} pricePerNight={villa.price} />
            </div>
          </div>
        </div>
      </div>
